import { Loader2, Sparkles, TicketPercent, ToolCase } from 'lucide-react'
...
const ProfessionalSummaryForm = ({ data, onChange, setResumeData }) => {
  ...
  const generateSummary = async () => {
    try {
        ...
        const prompt = `enhance my professional summery "${data.professional_summary}" `;
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            ...
            border text-sm border-gray-300 rounded-lg focus:ring-blue-500
            ...
            <p className='text-sm text-gray-500 max-w-4/5 mx-auto text-center'>Tip:
