...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">DigiTartib resume made undercutting all of our competitors an absolute breeze.</p>
        </div>
    );
  ...
  return (
    <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title="Don't just take our words" description="Hear what our users say about us. We'er always looking for ways to improve. If you have a positive experience with us, leave a review." />
